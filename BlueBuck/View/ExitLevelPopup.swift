...
internal final class ExitLevelPopup: UIView {
    ...
    override init(frame: CGRect) {
        ...
        okay.titleLabel?.font = UIFont(name: "HelveticaNeue-Bold", size: 18)
    ...
    private func setupConstraints() {
        ...
        layoutContraints.append(okay.rightAnchor.constraint(equalTo: rightAnchor, constant: -15))
        layoutContraints.append(okay.leftAnchor.constraint(equalTo:  gameCenter.rightAnchor, constant: 15))
