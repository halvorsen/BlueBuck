...
internal final class ObjectiveModel {
    ...
    internal static let objectivesByLevel: [BuckLevel: [(pattern: Pattern, amount: Int)]] = [
        .level1: [(.falcon, 3)],
        .level2: [(.falcon, 3),(.monkey, 4)],
        .level3: [(.turtle3, 3),(.turtle1, 2)],
        ...
        .level11: [(.ram1, 2),(.elephant, 2),(.ram2, 2)],
        .level12: [(.goat1, 2),(.armadillo1, 3),(.goat2, 2)],
        .level13: [(.armadillo1, 4),(.armadillo2, 2)],
        .level14: [(.monkey, 4)],
        .level15: [(.bat1, 3),(.bat3, 2),(.bat4, 1)],
        .level16: [(.falcon, 3),(.elephant, 1),(.rino1, 2)],
        .level17: [(.stag1, 2),(.goose1, 4),(.giraffe1, 2)],
        .level18: [(.mouse, 8)],
        .level19: [(.bat4, 3),(.goose2, 2),(.goat3, 2)],
